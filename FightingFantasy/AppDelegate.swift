...
class AppDelegate:  NSObject, NSApplicationDelegate, NSTableViewDelegate, NSTableViewDataSource,
    ...
    func applicationWillFinishLaunching(_ notification: Notification) {
        ...
        self.startSheet.preventsApplicationTerminationWhenModal = false
        self.aboutSheet.preventsApplicationTerminationWhenModal = false
        ...
        self.bookmarkViewController.view = bookmarkButtonView
    ...
    func applicationDidFinishLaunching(_ aNotification: Notification) {
        ...
        nc.addObserver(self,
                       selector: #selector(updatePack),
                       name: NSNotification.Name(rawValue: "set.pack.item.index"),
                       object: nil)
    ...
    func initUI() {
        ...
        if !self.tabs.tabViewItems.contains(magicTabItem) {
            self.tabs.insertTabViewItem(heldTabs["magicTabItem"]!, at: 4)
        }
    }
    ...
    @IBAction func adjustFear(_ sender: Any) {
        ...
        if let stepper = (sender as? NSStepper) {
            ...
            if !flag && psf > self.player!.maxFear { psf = self.player!.maxFear }
    ...
    @IBAction func combatLuckRoll(_ sender: Any) {
        ...
        success = roll <= self.player!.luck ? true : false
        ...
        if let myself = (sender as? AppDelegate) {
            ...
            if myself == self {
                if self.rollCount > 0 {
                    ...
                    self.dieOne.image = self.dice[roll]

                    roll = Int(arc4random_uniform(6))
                    self.dieTwo.image = self.dice[roll]
    ...
    func save(_ path: String) -> Bool {
        ...
        if let zplayer = self.player {
            ...
            zplayer.notes = self.notesTextView.string
    ...
    @IBAction func setPlayer(_ sender: Any) {
        ...
        if gameType == kGameCitadel {
            self.player!.magic = Int(arc4random_uniform(6) + arc4random_uniform(6)) + 8
            ...
            magicSpellsValue.stringValue = "\(self.player!.magic)"
        }
    ...
    @IBAction func showAbout(_ sender: Any) {
        ...
        self.aboutVersonLabel.stringValue = "v" + (Bundle.main.object(forInfoDictionaryKey: "CFBundleShortVersionString") as! String)
